...
export const MANICURES = withId([
  { name: "Basic Manicure", description: "Nail shaping, cuticle care and polish.", price: 20, duration: 30, icon: "fa-hand-sparkles" },
  { name: "Gel Manicure", description: "Long-lasting gel with LED cure.", price: 40, duration: 60, icon: "fa-droplet" },
  { name: "French Manicure", description: "Crisp white tips.", price: 50, duration: 60, icon: "fa-paintbrush" },
]);
...
export const PEDICURES  = withId([
  ...
  { name: "Spa Pedicure", description: "Sugar scrub, mask and massage.", price: 40, duration: 60, icon: "fa-spa" },
  { name: "Deluxe Pedicure", description: "Paraffin dip, extended massage.", price: 60, duration: 75, icon: "fa-gem" },
]);

export const DIPS = withId([
  { name: "Classic Dip", description: "Durable powder finish.", price: 40, duration: 60, icon: "fa-tint" },
...
export const ACRYLICS = withId([
  { name: "Full Set Acrylics", description: "Premium acrylic set.", price: 35, duration: 90, icon: "fa-square-plus" },
  { name: "Acrylic Fill", description: "Maintains existing acrylics.", price: 25, duration: 60, icon: "fa-fill-drip" },
...
export const ADDONS = withId([
  ...
  { name: "Gel Top Coat Add-On", description: "Ultra-shiny finish.", price: 15, duration: 10, icon: "fa-gem" },
]);
